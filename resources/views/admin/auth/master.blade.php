...
@endphp
  ...
  @yield('content')
    ...
    <script src="{{($dir)}}/js/moment.min.js"></script>
    <script src="{{($dir)}}/js/bootstrap.min.js"></script>
    <script src="{{($dir)}}/js/simplebar.min.js"></script>
    <script src='{{($dir)}}/js/daterangepicker.js'></script>
    <script src='{{($dir)}}/js/jquery.stickOnScroll.js'></script>
    <script src="{{($dir)}}/js/tinycolor-min.js"></script>
    <script src="{{($dir)}}/js/config.js"></script>
    <script src="{{($dir)}}/js/apps.js"></script>
