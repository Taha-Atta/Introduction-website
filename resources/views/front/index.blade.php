...
@section('content')
            ...
            <div class="row align-items-center" style="height: 250px;">
                <div class="col-12 col-md-6">
                    ...
                    <form method="post" action="{{ route('front.subscriber.store') }}">
                        ...
                        @enderror
                        @if (session('success'))
                            <span class="text-withe">{{session('success') }}</span>
                        @endif
                    </form>
                </div>
    ...
    <x-front-service-componant></x-front-service-componant>
    <!-- Service End -->


    <!-- Features Start -->

    <x-front-features-componant></x-front-features-componant>
    <!-- Features End -->
    ...
    <!-- Testimonial Start -->
    <x-front-testimoail-componant></x-front-testimoail-componant>
    <!-- Testimonial End -->
    ...
    <x-members-compomant></x-members-compomant>
